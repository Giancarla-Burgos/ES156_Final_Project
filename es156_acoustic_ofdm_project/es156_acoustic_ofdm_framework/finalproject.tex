...
The mathematical foundation follows standard signals-and-systems and digital-communication models for LTI convolution, impulse responses, Fourier analysis, PAM pulse shaping, matched filtering, detection, and ISI \cite{oppenheim1997,chaparro2019,proakis2008,kay1998}. The multicarrier extension follows the DFT-based OFDM idea of Weinstein and Ebert \cite{weinstein1971}, later surveyed by Bingham \cite{bingham1990}, and standard treatments of cyclic prefixes, frequency-domain equalization, and rate/robustness tradeoffs \cite{nee2000,tse2005}. The synchronization step is related to repeated-preamble OFDM timing methods such as Schmidl and Cox \cite{schmidl1997}. 
...
\begin{center}
\url{https://github.com/Giancarla-Burgos/ES156_Final_Project}
\end{center}
...
\bibitem{chaparro2019}
L.~F. Chaparro and A.~Akan, \emph{Signals and Systems Using MATLAB}, 3rd~ed. London, U.K.: Academic Press, 2019.

\bibitem{proakis2008}
J.~G. Proakis and M.~Salehi, \emph{Digital Communications}, 5th~ed. New York, NY, USA: McGraw-Hill, 2008.

\bibitem{kay1998}
S.~M. Kay, \emph{Fundamentals of Statistical Signal Processing, Volume II: Detection Theory}. Upper Saddle River, NJ, USA: Prentice Hall, 1998.
...
\bibitem{tse2005}
D.~Tse and P.~Viswanath, \emph{Fundamentals of Wireless Communication}. Cambridge, U.K.: Cambridge University Press, 2005.
